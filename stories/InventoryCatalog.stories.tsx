...
export const InventoryInspectionsManagerStory: Story = { name: "InventoryInspectionsManager", render: () => <InventoryInspectionsManager actorRole="admin" currentUserId="user-1" initialInspections={[STORY_INSPECTION]} initialInspectionId={STORY_INSPECTION.id} rooms={[STORY_ROOM]} technicians={[{ id: "user-1", fullName: "Алия Сарсенова", role: "employee" }]} canExport /> };
