...
const serviceRequest: ServiceRequestDto = {
  ...
  author: { id: "user-1", name: "Дана Ахметова" },
  responsible: { id: "user-2", name: "Алия Сарсенова" },
  type: "not_working",
...
const request: TmcTransferRequestCardView = {
  id: "request-1",
  initiator: { fullName: "Дана Ахметова", email: "tester@tester.com" },
  recipient: { fullName: "Алия Сарсенова", email: "admin@admin.com" },
  status: "pending",
  ...
  items: [{
    ...
    responsibleUserProfile: { fullName: "Алия Сарсенова" },
    result: "pending",
    version: 1,
  }],
};
...
export const TmcRequestMetaStory: Story = { name: "TmcRequestMeta", render: () => <TmcRequestMeta label="Получатель" value="Алия Сарсенова" /> };
...
export const TmcUserPickerStory: Story = { name: "TmcUserPicker", render: () => <TmcUserPicker value={{ id: "user-1", fullName: "Алия Сарсенова", email: "admin@admin.com", role: "admin" }} onChange={() => undefined} /> };
